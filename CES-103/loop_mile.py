...
import random
#creavity: random words in a list(variables), and the user can choose to stop playing before finding the secret word.
#ps: The program works in CAPS.

words=['jesus','daniel','mathew','jacob','nephi','lehi','jeremiah','laman', 'samuel','ruth','rachel'] 
...
while guess.lower() != secret_w and guess.lower() !='stop':
        ...
        while len(guess) != len(secret_w) and guess.lower()!='stop':
            ...
            guess= input('\nWhat is your guess? ')#loops if either the user types len != words or STOP
        print('\nYour hint is:')    
